    ...
    >
      ...
      <div
        className={`font-main min-h-screen h-fit flex w-full bg-[#F0EBD8] text-[#0D1321]
          dark:bg-[#0D1321] dark:text-[#F0EBD8] py-8 flex-col no-scrollbar`}
      >
        <Header />
        <h2 className="max-w-4xl mx-auto text-7xl mb-6 text-shadow-lg dark:text-shadow-[#2E455D] text-shadow-[#B2BCC2]">
          Probably better than your favorite <strong>developer</strong>.
        </h2>
        <Details />
        <AllInfo />
      </div>
