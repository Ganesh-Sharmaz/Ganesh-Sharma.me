...
const variantClasses: Record<ActionVariant, string> = {
  ...
  neutral:
    "px-4 h-[50px] sm:h-[36px] sm:w-[78px] py-2 text-xs font-medium bg-[#F0EBD8]  text-gray-700 dark:bg-[#0D1321] dark:text-gray-300 rounded-md shadow-sm border border-[#748CAB] dark:border-[#1D2D44] transition-all hover:pt-[0.40rem] hover:border-b-4 hover:border-slate-40",
  icon:
